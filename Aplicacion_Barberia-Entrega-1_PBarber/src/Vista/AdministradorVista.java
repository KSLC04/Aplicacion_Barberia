...
/**
 * La clase AdministradorVista representa la interfaz gráfica del administrador
 * de la barbería. Permite al administrador gestionar clientes y empleados,
 * así como acceder a diferentes funciones a través de botones.
 */

public class AdministradorVista extends JFrame {
    public AdministradorControl controlador;
    ...
    public void initUI() {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {
            CrearEmpleadoVista crearEmpleadoVista = new CrearEmpleadoVista(AdministradorVista.this);
            crearEmpleadoVista.setVisible(true); 
            dispose();  // Cerrar la ventana de AdministradorVista 
        }
        });
        ...
        btnVerEmpleados.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                controlador.verListadoEmpleados();  //jjjjjjjjjjjjjjjjjjjj
            }
        });
    ...
    /**
     * Método principal para iniciar la aplicación y mostrar la vista del administrador.
     * Usamo mayormente para pruebas
     */
