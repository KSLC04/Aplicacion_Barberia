...
/**
 * La clase MenuInicioVista representa la interfaz gráfica del menú de inicio
 * para la aplicación de administración de barbería. Permite a los usuarios
 * ingresar sus credenciales y redirige a diferentes menús según su rol (administrador, cliente, empleado).
 */
...
public class MenuInicioVista extends JFrame {
    ...
    // Simulacion de una base de datos de usuarios (username, password, role)
    ...
    public MenuInicioVista() {
        ...
        createLoginGUI();
        createImage(); // Metodo para cargar la imagen
     ...
     * Comprueba las credenciales del usuario y redirige según su rol.
     */
    ...
    private void validateLogin() {
     ...
     /**
     * Método para redirigir al menú dependiendo del rol del usuario.
     */
